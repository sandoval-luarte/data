...
BW_data <- read_csv("../data/BW.csv") %>%
    ...
    filter(!ID %in% c(
        7860, 7862, 7864, 7867, 7868, 7869, 7870, 7871, 7873, 7875, 7876, 7879, 7880, 7881,
        7882, 7883
    )) %>% # ad lib C57
...
echoMRI_data <- read_csv("../data/echomri.csv") %>%
    ...
    mutate(
        ...
        STATUS = case_when(
            ...
            STRAIN == "C57BL6/J" & Date %in% as.Date(c(
                "2025-08-28", # 7878 last day of echo
            ...
            STRAIN == "NZO/HlLtJ" & Date %in% as.Date(c(
